...
const Register = () => {
    ...
    return (
        <div className='register'>
            <form className='border p-5 bg-opacity-50 shadow rounded-3' style={{backgroundColor:`rgb(214,215,215)`}} onSubmit={handleSubmit(submit)} >

                <div className='m-3'>
                    <p className='display-6 text-center px-5 mx-5'>REGISTER</p>
                </div>
                <hr />
                {/* name */}
                <div className="mb-3">
                ...
                <div>
                    <h7>
                        Already have an account? <span className='btn text-primary' onClick={handleSignin}> Signin</span>
                    </h7>
                </div>
